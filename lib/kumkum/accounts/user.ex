defmodule Kumkum.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Kumkum.Repo)
...
def yui()do
  ...
  """
  def valid_password?(%Kumkum.Accounts.User{hashed_password: hashed_password}, password)
